...
from src.output_processing.custom_functions import (evaluate_model, plot_losses, plot_evaluation_metrics,
...
from src.utils.constants import (BASE_PATH, HYPERBAND_PATH, ELECTRICITY)
    ...
    for _ser in series_type:
        for look_back_day in look_backs:
            for forecast_day in forecast_periods:
                print(f"Tuning with series_type={_ser} | look_back={look_back_day} | forecast_period={forecast_day}")
